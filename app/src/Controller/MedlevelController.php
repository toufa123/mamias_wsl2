...
class MedlevelController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        $ob11->title->text('Temporal variability in numbers of new reported marine non-indigenous species');
        $ob11->title->style(
            [
                'fontFamily' => 'Roboto Light',
                'fontSize' => '18px',
        ...
        $ob11->series([['name' => 'numbers of new reported marine non-indigenous species', 'color' => '#00AEEF', 'data' => $datareg]]);
        //dump( $b, $datareg1);die;
