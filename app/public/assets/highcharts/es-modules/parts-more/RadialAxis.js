...
radialAxisMixin = {
    ...
    getPlotLinePath: function (options) {
        var axis = this, center = axis.center, chart = axis.chart, inverted = chart.inverted, value = options.value,
            reverse = options.reverse, end = axis.getPosition(value), background = axis.pane.options.background ?
            ...
            x1 = center[0] + chart.plotLeft, y1 = center[1] + chart.plotTop, x2 = end.x, y2 = end.y, a, b, otherAxis,
            xy, tickPositions, crossPos, ret;
        // Crosshair logic
